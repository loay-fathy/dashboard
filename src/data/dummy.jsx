    ...
    <>
      <label className="flex cursor-pointer select-none items-center">
        <div className="relative">
          ...
          />
          <div
            className={`block h-7 w-13 rounded-full bg-[#E5E7EB] ${
              isChecked && "bg-blue-500"
            }`}
          ></div>
          <div
            className={`dot absolute bottom-1 h-5 w-5 rounded-full bg-white transition ${
