...
const Ecommerce = () => {
  ...
  return (
    <div className="w-[94%] mx-auto  mt-10">
      ...
      <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-10 justify-between">
        <div className="col-span-2 rounded-md overflow-hidden">
          <ChartComponent
            id="chart2"
            background={chartColor === "dark" ? "#25282a" : "#fff"}
            primaryXAxis={{
              valueType: "DateTime",
              labelFormat: "dd MMM",
          ...
          >
            <Inject
              services={[AreaSeries, DateTime, Legend, Tooltip, Highlight]}
            />
            <SeriesCollectionDirective>
              <SeriesDirective
                dataSource={data1}
